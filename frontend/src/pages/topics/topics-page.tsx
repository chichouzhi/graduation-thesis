...
function resolveTopicsMode(role?: string | null): TopicsMode {
  if (role === "teacher") {
    return "teacher";
  }
...
export function TopicsPage() {
  ...
  useEffect(() => {
    setMode(resolveTopicsMode(currentUser?.role));
  }, [currentUser?.role]);

  const showModeSwitcher = !currentUser || currentUser.role === "admin";
    ...
    <div className="page-stack">
      <PageSection className="hero-section">
        ...
        <p className="hero-copy">
          学生可在这里填写个人信息并查看适合的题目，老师可切到分析工作区处理题目画像与志愿。
        </p>
